...
public class MobileClass {
	// The Mobile Class which is created in JustDialPages will call this function. Corresponding to the individual 
	// class of string this function will return individual character for generation mobile number.
